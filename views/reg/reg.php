...
<!--SIGN UP-->
<h1 style="backface-visibility: 20%;">用户注册</h1>
<div class="login-form">
    ...
    <?php echo $form->field($model,'email')->textInput(['class' => 'text','placeholder' => '邮件'])->label(false);?>
    <div class="key">
        <?php echo $form->field($model,'password')->passwordInput(['placeholder' => '密码'])->label(false);?>
    </div>
    <div class="signin">
        <?php echo Html::submitButton('注册',["class" => "signin",
